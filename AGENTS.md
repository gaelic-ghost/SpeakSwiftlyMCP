...
- When `speak-to-user` adopts a new `SpeakSwiftlyMCP` version, prefer updating the submodule pointer to a tagged `SpeakSwiftlyMCP` release rather than an arbitrary branch tip.
